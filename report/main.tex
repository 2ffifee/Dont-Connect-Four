...
W ramach projektu modele językowe zostały wykorzystane przy:
\begin{itemize}
    \item Tworzeniu GUI aplikacji
    \item Tworzeniu kodu do obsługi gry z LLMami
    \item TWorzeniu skryptów przeprowadzających eksperymenty
    \item Tworzenia wykresów i tabel z wynikami
    \item Wygenerowania bibliografii
\end{itemize}
...
\subsection{Uwaga pokońcowa}
W wieczór przed terminem oddania projektu, została znaleziona strategia wygrywająca dla gracza żółtego. Celem dalszych badań należałoby rozważyć wprowadzenie jakiegoś mechanizmu sprawiedliwości turowej, np. grania zawsze do wypełnienia całej planszy i zliczania linii.
